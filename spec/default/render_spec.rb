...
RSpec.describe Metanorma::Requirements::Default do
  ...
  it "processes requirements" do
    input = <<~INPUT
          <iso-standard xmlns="http://riboseinc.com/isoxml">
          <preface><foreword>
          <requirement id="A" keep-with-next="true" keep-lines-together="true" model="default">
    ...
    presxml = <<~OUTPUT
      <foreword id="_" displayorder="2">
         ...
         <requirement id="A" keep-with-next="true" keep-lines-together="true" model="default" autonum="1">
            <fmt-name id="_">
               <span class="fmt-caption-label">
  ...
  it "processes requirements in French" do
    ...
    presxml = <<~OUTPUT
      <foreword id="F" displayorder="2">
         ...
         <requirement id="A" model="default" autonum="1">
            <fmt-name id="_">
               <span class="fmt-caption-label">
            ...
            <fmt-provision id="A" model="default" autonum="1">
               <p>
                  <em>
                     Sujet :
                     <semx element="subject" source="_">user</semx>
